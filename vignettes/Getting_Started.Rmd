...
```{r setup,eval = FALSE}
# library(DMSTAr)
# for now till we get acutal code in here
```
...
## Core Concepts
Before running a model, it hepls to understand a few core terms/concepts used throghout `DMSTAr` taken from DMSTA. For more information on DMSTA specifically, please visit the [DMSTA2](https://wwwalker.net/dmsta/) webpage.
